   ...
   #      return self.cs, self.y, f, i, c, o
    ...
    def forwardProp(self):
        for i in range(1, self.rl+1):
            ...
            #set input to the next word of the sequence
            self.x = self.eo[i-1]
        return self.oa
...
def LoadText():
    ...
    #print returnData, uniqueWords, output, outputSize
...
returnDate2 = returnData[1:-1]
returnDate3 = returnData[-1]
RNN = RecurrentNeuralNetwork(returnDate, numCategories, outputSize, expectedOutput, learningRate)
